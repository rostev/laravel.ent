...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Laravel enterprise</title>
                        ...
                        <div class="p-6">
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquam amet at dicta
                                    dolores eius illum molestiae odio optio quae vero?
                                </div>
                            </div>
                        </div>
